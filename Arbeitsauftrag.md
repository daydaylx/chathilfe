...
## Aktueller Zusatzauftrag

Wenn an Issue #19 gearbeitet wird, zusätzlich lesen:

- [`docs/WHATSAPP_DIALOG_CONTEXT.md`](docs/WHATSAPP_DIALOG_CONTEXT.md)
...
- Mehrere bewusst eingefügte WhatsApp-Nachrichten dürfen als temporärer Dialogauszug geparst werden.
- Ziel ist bessere Kontexttrennung, nicht ein Chatverlauf-Feature.
- Umsetzung nur als schlanker Parser + Prompt-Kontext + Tests.
- Keine Speicherung, kein Profil, kein Gedächtnis, kein automatisches WhatsApp-Lesen.
